...
/* digitalWrite is used to write a HIGH or a LOW value to a specified digital pin (LOW and HIGH is the voltage level of the particular pin) */
    ...
    if(a>   100 && b>100){            // Forward Movement

    digitalWrite(8,LOW);           // Pin 8 is High for Motor Output 2

    digitalWrite(9,HIGH);            // Pin 9 is Low

    digitalWrite(10,LOW);         // Pin 10 is High for Motor Output 1

    digitalWrite(11,HIGH);          // Pin 11 is Low
